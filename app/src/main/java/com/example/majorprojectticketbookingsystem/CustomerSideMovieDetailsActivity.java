...
public class CustomerSideMovieDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_side_movie_details);
        ...
        btnShowTheatres = findViewById(R.id.btnShowTheatres);
        ...
        if (movie != null) {
            ...
            Glide.with(CustomerSideMovieDetailsActivity.this)
        ...
        btnShowTheatres.setOnClickListener(v -> {
            Intent intent = new Intent(CustomerSideMovieDetailsActivity.this, CustomerSideChooseTheatreActivity.class);
        ...
        movieApiService.getMovieTrailerAndTeaser(new MovieApiService.DataCallback() {
            ...
            public void onSuccess(JSONObject response) {
                ...
                catch (JSONException e)
                {
                    ...
                    Toast.makeText(CustomerSideMovieDetailsActivity.this, "JSON parsing error", Toast.LENGTH_SHORT).show();
                }
            }
